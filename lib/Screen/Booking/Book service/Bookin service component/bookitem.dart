                          ...
                          child: Row(
                            children: [
                              ...
                              Column(
                                ...
                                children: [
                                  RichText(
                                   ...
                                   Padding(
                                     ...
                                     child: Text('Original Amount :               ₹$originalprice',
                               ...
                               Padding(
                               padding: const EdgeInsets.only(bottom:3 ),
                                 child: Text('Vendor Discount  :               ₹$discountprice',style: const TextStyle(
                                          color: Color.fromRGBO(85, 32, 32, 1),
                                          fontFamily: 'EBGaramond',
                                          fontSize: 14,
                                          letterSpacing: 0,
                                ...
                                Padding(
                               padding: const EdgeInsets.only(bottom:3 ),
                                  child: Text('Payable Amount   :               ₹$finalprice',style: const TextStyle(
                                          color: Color.fromRGBO(85, 32, 32, 1),
                                          fontFamily: 'EBGaramond',
                                          fontSize: 14,
                                          letterSpacing: 0,
