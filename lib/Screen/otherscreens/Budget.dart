                  ...
                  child: ExpansionTile(
                    ...
                    children:  [
                     const SizedBox(height: 10,),
                      Budgetbox('assets/images/Vendor_carting.jpg', 'Catering', 10000),
                       const SizedBox(height: 10,),
                       Budgetbox('assets/images/vender_photography.jpg', 'Photography', 120000),
                      const SizedBox(height: 10,),
                       Budgetbox('assets/images/Vender_Venue.jpg', 'Venue',150000),
                      const SizedBox(height: 10,),
                        Budgetbox('assets/images/vendor_Groom_wear.jpg', 'Groom Wear', 20000),
                      const SizedBox(height: 10,),
                       Budgetbox('assets/images/Vendor_invitations.jpg', 'Invitations',2500),
                      const SizedBox(height: 10,),
                       Budgetbox('assets/images/Vendor_carting.jpg', 'Catering', 15000),
                      const SizedBox(height: 10,),
                    ],
                  ),
                ),
                  ...
                  child: Card(
                    ...
                    child: ExpansionTile(
                      ...
                      children:  [
                        ...
                        Budgetbox('assets/images/Vendor_carting.jpg', 'Catering', 10000),
                        const SizedBox(height: 10,),
                         Budgetbox('assets/images/Vender_Mackup.jpg', 'Mack-up', 2000),
                        const SizedBox(height: 10,),
                         Budgetbox('assets/images/vender_photography.jpg', 'Photography', 120000),
                        const SizedBox(height: 10,),
                         Budgetbox('assets/images/Vender_Venue.jpg', 'Venue', 150000),
                        const SizedBox(height: 10,),
                         Budgetbox('assets/images/Vendor_bridal_wear.jpg', 'Bridal Wear', 50000),
                        const SizedBox(height: 10,),
                         Budgetbox('assets/images/Vendor_invitations.jpg', 'Invitations', 2500),
                        const SizedBox(height: 10,),
                         Budgetbox('assets/images/Vendor_carting.jpg', 'Catering', 15000),
...
Widget expandedtitle(String image, double number, String title) {
   final formattedPrice1 = NumberFormat.currency(locale: 'en_IN', symbol: '₹',decimalDigits: 0).format(number);
  return Row(
  ...
  final formattedPrice = NumberFormat.currency(locale: 'en_IN', symbol: '₹').format(venueprice);
              ...
              children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    borderRadius: const BorderRadius.all(Radius.elliptical(65, 65)),
                  ),
                ),
                const SizedBox(
                  width: 25,
