...
class SupportW extends StatefulWidget {
  const SupportW({super.key});

  @override
  State<SupportW> createState() => _SupportWState();
}

class _SupportWState extends State<SupportW> {
  @override
              ...
              Container(
                ...
                decoration: const BoxDecoration(
                    image: DecorationImage(
                        image: AssetImage(
                            'assets/images/account_contact_customer-service_icon.png'),
                        fit: BoxFit.cover)),
              ),
              const SizedBox(
                height: 20,
