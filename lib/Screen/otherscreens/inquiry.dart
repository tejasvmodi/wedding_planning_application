...
class _InquiryWState extends State<InquiryW> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(  backgroundColor: const Color.fromRGBO(255, 217, 249, 1),
        leading: IconButton(
          onPressed: () {
              ...
              decoration: BoxDecoration(
                  ...
                  boxShadow: const [
                    BoxShadow(blurRadius: 3, color: Colors.transparent)
                          ...
                          child: const TextField(
                            ...
                            maxLines: 4,
                            decoration: InputDecoration(border: OutlineInputBorder(borderSide: BorderSide.none),hintText: 'Write Inquiry',hintStyle:  TextStyle(
                                    color: Color.fromRGBO(85, 32, 32, 1),
                                    fontFamily: 'EBGaramond',
                                    fontSize: 20,
                                    letterSpacing: 0,
                  ...
                  child: TextButton(onPressed: () {}, 
                   style: ButtonStyle(
                    ...
                    ),child: const Text('Get A Quote ', textAlign: TextAlign.left,
                      style: TextStyle(
                          color: Colors.white,
                          fontFamily: 'EBGaramond',
                          fontSize: 23,
